...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: n4afuKb3I9l31b/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: QoT_lz3OPd1ZNk/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: lnVxdE6WN_6A6c/icon
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__hYmjZ)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__lzDyx)}
                role={"img"}
              />
            ),
